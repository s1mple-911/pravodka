/* =====================================================================
   ...
   🔴 perms-dev.js NAQSHI: bu fayl 15 sahifa uchun BITTA. Ichida birorta
   ...
   perms-dev.js yuklanmagan / my_perms() hali kelmagan holatda PERMS = OPEN
...
(function () {
  ...
  /* Havola qo'shimchasi joriy fayl nomidan: dev sahifada `-dev.html`,
     prod sahifada `.html` (perms-dev.js dagi bilan aynan bir xil). */
  ...
  function allowed() {
    var p = window.PERMS;
    if (!p || typeof p !== 'object') return false;   // perms-dev.js yo'q -> YASHIRIN
